...
export default function Index() {
  ...
  useEffect(() => {
    const animateLoader = async () => {
      ...
      animate(containerRef.current, { rotate: 360 }, { duration: 4, ease: 'linear', repeat: Infinity })
    }
    animateLoader()
  }, [animate, characters])
  ...
  return (
    <motion.div className=" z-50 flex min-h-screen items-center justify-center">
      <motion.div variants={slideUp} initial="initial" exit="exit" className={`${styles.introduction} min-h-screen`}>
        {dimension.width > 0 && (
          <>
